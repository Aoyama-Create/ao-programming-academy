...
const navItems = [
  ...
  { href: "/stage3", label: "Stage 3 教材" },
  { href: "/stage4", label: "Stage 4 教材" },
  { href: "/stage5", label: "Stage 5 教材" },
  { href: "/stage6", label: "Stage 6 教材" },
  { href: "/stage7", label: "Stage 7 教材" },
  { href: "/stage8", label: "Stage 8 教材" },
